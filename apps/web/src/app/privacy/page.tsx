    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-[780px] mx-auto px-6 py-10">
        ...
        <div className="text-[14px] text-gray-800 leading-relaxed space-y-6">
          ...
          <p>회사는 통합 로그인 및 데이터 관리 시스템을 기반으로 CharacterVerse 서비스 및 이에 부수하는 제반 서비스(통칭하여 이하 '서비스')를 제공하고 관리합니다.</p>
          ...
          <section>
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  <tr>
                    <td className="border border-gray-300 px-3 py-2">아이디 및 비밀번호 찾기, CharacterVerse 서비스 제공을 위한 회원가입 및 이용자 식별, 문의 및 민원 처리</td>
              ...
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-300 px-3 py-2">CharacterVerse AI 서비스 제공 및 서비스 성능, 알고리즘 개선</td>
                    <td className="border border-gray-300 px-3 py-2">AI 대화 정보(텍스트·이미지·비디오·음성 등을 포함한 대화 내용) / 서비스 이용 행태 정보(입력 정보 및 결과물)</td>
                    <td className="border border-gray-300 px-3 py-2">회원탈퇴 시까지</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-3 py-2">CharacterVerse</td>
