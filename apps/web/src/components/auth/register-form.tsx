    ...
    content: (
      <div className="prose prose-sm max-w-none text-gray-800 leading-relaxed space-y-6 text-[14px]">
        ...
        <section>
          ...
          <p>이 약관은 Zac∞(이하 '회사')은(는) 회사가 운영하는 Zac∞ 및 이에 부수하는 제반 서비스(통칭하여 이하 '서비스')의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 하며, 본 약관에 동의함으로써 해당 서비스들도 별도 이용계약 체결없이 이용이 가능합니다.</p>
        </section>
        <section>
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center px-4">
      ...
      <div className="w-full max-w-[560px] pt-16 pb-10 text-center">
        <div className="text-[#E8613C] font-bold text-base mb-2">Zac∞</div>
      ...
      <div className="w-full max-w-[560px]">
        <div className="mb-5">
          <p className="text-sm font-semibold text-gray-800">Zac∞ 계정</p>
    ...
    >
      <div className="text-center mb-8">
        <Link href="/" className="inline-flex items-center gap-2.5 mb-6">
          ...
          <span className="font-bold text-xl gradient-text">Zac∞</span>
        </Link>
